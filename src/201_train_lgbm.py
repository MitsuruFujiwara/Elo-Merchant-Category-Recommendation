...
def kfold_lightgbm(train_df, test_df, num_folds, stratified = False, debug= False):
    ...
    for n_fold, (train_idx, valid_idx) in enumerate(folds.split(train_df[feats], train_df['outliers'])):
        ...
        params ={
                ...
                'metric': 'rmse',
                'learning_rate': 0.01,
                'subsample': 0.356158040552289,
                'max_depth': 6,
                'num_leaves': 53,
                'min_child_weight': 31.2596303287465,
                'reg_alpha': 0.509547503478947,
                'colsample_bytree': 0.252760421315796,
                'min_split_gain': 5.90183716795304,
                'reg_lambda': 4.29651519868909,
                'min_data_in_leaf': 64,
                'verbose': -1,
                'seed':int(2**n_fold),
